    ...
    return (
        <div className="container-fluid mb-5 mt-3">
            <div class="row mx-1 gap-5 d-flex justify-content-center flex-colum mb-3">
                <div class="col-sm-5 col-11 col-sm-6 col-lg-4 slogan align-self-start cardBodyMorphoric">

                    <div class="card-body p-3 pb-5" >
                        <h5 class="card-title">Our Slogan</h5>
                ...
                <div class="col-sm-5 col-11 col-lg-4 mission cardBodyMorphoric">
                ...
                <div class="col-md-9 col-sm-9 col-11 col-lg-7 align-self-start cardBodyMorphoric">
                    <div class="card-body p-3 pb-5" >
